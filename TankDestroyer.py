import sys
from data.src.menu import Menu
from data.src.interface import Interface
from data.src.player import Player
from data.src.spawn_enemy import Spawn
from data.src.bullet import *
from data.src.stats import Stats
from data.src.sounds import Sounds
...
class TankDestroyer:
    ...
    def __init__(self):
        ...
        self.bg = pygame.image.load("data/images/tank_field.png")
