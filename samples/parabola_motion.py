...
@date 09/11/2021
@version 1
@file projectile_parabola_motion(testing).py

Description: This is a sample code for parabola movement
modifying angle of travel. Solution for optional increament for object
that user can select how the parabola motion is going to
display. This sampel is preparing for the laser charging effect 
for boss object in the Project TD. This prototype applies elipse equation on
projectile movement in a perfect pattern
