...
class Player(Sprite):
    def __init__(self, access):
        ...
        self.player_images = {"left": [pygame.image.load("Pics/tank_left(1).png"),
                                       pygame.image.load("Pics/tank_left(""2).png"),
                                       pygame.image.load("Pics/tank_left(3).png"),
                                       pygame.image.load("Pics/tank_left(4).png")],
                              ...
                              "up": [pygame.image.load("Pics/tank_up(1).png"),
                                     pygame.image.load("Pics/tank_up(2).png"),
                                     pygame.image.load("Pics/tank_up(3).png"),
                                     pygame.image.load("Pics/tank_up(4).png")],
                              "down": [pygame.image.load("Pics/tank_down(1).png"),
                                       pygame.image.load("Pics/tank_down(2).png"),
                                       pygame.image.load("Pics/tank_down(3).png"),
                                       pygame.image.load("Pics/tank_down(4).png")]}
        self.direction = "up"
        self.index = 0
