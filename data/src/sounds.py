...
class Sounds:
    def __init__(self, access):
        ...
        self.gametrack = mixer.Sound("./data/sounds/Theme/BattleInTheWinter.wav")

        self.shoot_effect = mixer.Sound("./data/sounds/Effects/CanonDistanceFire-01.wav")
        self.gatling_effect = mixer.Sound("./data/sounds/Effects/MachineGun.wav")
        self.move_effect = mixer.Sound("./data/sounds/Effects/TankMoving.wav")
        self.laser_effect = mixer.Sound("./data/sounds/Effects/LaserGun.wav")
        self.laser_charge_effect = mixer.Sound("./data/sounds/Effects/LaserChargeEffect.wav")
        self.explode_effect = mixer.Sound("./data/sounds/Effects/GiantExplosion.wav")
        self.button_change = mixer.Sound("./data/sounds/Button/button02.wav")
        self.button_access = mixer.Sound("./data/sounds/Button/button05.wav")
